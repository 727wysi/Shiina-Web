...
@Getter
public class OnUserUnDenyClanEvent extends ShiinaEvent {

    private int clanId;
    private int userId;
    private int adminId;

    public OnUserUnDenyClanEvent(int clanId, int userId, int adminId) {
        this.clanId = clanId;
        this.userId = userId;
    ...
    public void call(ShiinaEventListener listener) {
        listener.onUserUnDenyClanEvent(this);
    }
